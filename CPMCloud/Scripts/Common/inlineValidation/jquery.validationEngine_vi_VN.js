    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "maxSize": {
                    "regex": "none",
                    "alertText": "Chỉ được phép nhập tối đa ",
                    "alertText2": " ký tự"
                },
                "maxFileSize": {
                    "regex": "none",
                ...
                "equaMin": {
                    "regex": "none",
                    "alertText": "Phải nhập giá trị lớn hơn "
                },
                //D2T sửa từ số nguyên sang giá trị cho dễ dùng trong nhiều trường hợp
                "min": {
                    "regex": "none",
                    "alertText": "Phải nhập giá trị lớn hơn hoặc bằng "
                },
                //END
                "max": {
                    "regex": "none",
                    "alertText": "Phải nhập số nhỏ hơn hoặc bằng "
                },
                "step": {
                    "regex": "none",
                    "alertText": "Phải nhập số phù hợp với đơn vị tính: "
                },
                "past": {
                    "regex": "none",
                ...
                "phone": {
                    ...
                    "alertText": "Số điện thoại xác nhận không đúng"
                },
                "mobilePhone": {
                    "regex": /^\d+$/,
                ...
                "number": {
                    ...
                    "regex": /^([\-\+]\d+)?((([0-9]{1,3})([0-9]{3})*)|([0-9]+))?([\.]([0-9]+))?$/,
                    "alertText": "Không đúng là số thập phân dạng x.y"
                },
                "numberDecimal": {
                    // Number, including positive, negative, and floating decimal. credit: orefalo
                    "regex": /^([^\.]+)?([\.]([0-9]{1,3}))?$/,
                    "alertText": "Tối đa chỉ nhập 3 chữ số thập phân (ví dụ: 0.123)"
                },
                "numberDecimal2": {
                    // Number, including positive, negative, and floating decimal. credit: orefalo
                    "regex": /^([^\.]+)?([\.]([0-9]{1,2}))?$/,
                    "alertText": "Tối đa chỉ nhập 2 chữ số thập phân (ví dụ: 0.12)"
                },
                "date": {
                ...
                "onlyOperator": {
                    "regex": /^[+\-\*/]{0,1}$/,
                    "alertText": "Chỉ điền toán tử [+, -, *, /]"
                },
                "onlyOperatorPlus": {
                    "regex": /^[+\-]{0,1}$/,
                    "alertText": "Chỉ điền toán tử [+, -]"
                },
                "onlyOperatorConditions" : {
                	"regex": /^[<>=]{0,1}$/,
                    "alertText": "Chỉ điền toán tử điều kiện [>, <, =]"
                },
                "onlyLetterSp": {
                    "regex": /.+$/,
                ...
                "onlyLetterNumberCode": {
                	"regex": /^([a-zA-Z])([a-zA-Z0-9_])*$/,
                    "alertText": "Chỉ được phép nhập các ký tự từ [A -> Z], [0 -> 9] và ký tự [_]. Bắt đầu bằng ký tự chữ. Ví dụ: TC_01"
                },
                "onlyLetter": {
                	"regex": /^(?!.*[0-9]+$)/,
                ...
                "beforeAfter": {
                    "regex": "none",
                    "alertText": "Giá trị không được lớn hơn "
                },
                "beforeAfterInt": {
                    "regex": "none",
                    "alertText": "Giá trị không được lớn hơn "
                ...
                //validate chọn khoảng ngày tháng
                "dateChooserRanger": {
                    "func": function(field, rules, i, options) {
                        var test = field.val();
                        if(!test || test === "") return true;
                        var pattern = new RegExp(/^\d{1,2}(\-|\/|\.)\d{1,2}\1\d{4}\s+\-\s+\d{1,2}(\-|\/|\.)\d{1,2}\1\d{4}$/);
                        if (!pattern.test(test)) {
                            return false;
                        }
                        var dates = test.split("-");
                        var fromDate = trim(dates[0]);
                        var toDate = trim(dates[1]);
                        if(tctIsDateFormat(fromDate) === 0 && tctIsDateFormat(toDate) === 0 ) {
                            return false;
                        }
                        return (tctCompareDates(fromDate, toDate) <= 0);
                    },
                    "alertText": "Ngày không đúng định dạng (dd/mm/yyyy), ngày bắt đầu phải nhỏ hơn hoặc bằng ngày kết thúc"
                },
                "formatDate": {
                    "regex": /^\d{1,2}(\-|\/|\.)\d{1,2}\1\d{4}$/,
